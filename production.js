...
function getFiltered(statusList) {
    ...
    const parseSeq = (o) => {
        const pNum = o.production_number;
        if (pNum) {
...
function renderOrderCard(o) {
    ...
    <div class="order-card ${cardCls}" id="card_${o.id}">
        ...
        <div style="margin-top:12px;padding:10px 12px;background:rgba(129,140,248,0.12);border:1px solid rgba(129,140,248,0.3);border-radius:8px;font-size:1.05rem;font-weight:700;color:#a5b4fc;display:flex;align-items:center;justify-content:space-between;gap:8px;">
